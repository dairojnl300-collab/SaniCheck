    ...
    return `
      <div style="padding:12px 0;border-bottom:1px dashed var(--color-border);">
        ...
        ${desc || it.normativa ? `
          ...
          <div id="perfil-desc-${_esc(descKey)}" class="text-prose" style="display:${descOpen ? 'block' : 'none'};margin-top:8px;padding:10px 12px;background:rgba(27,67,50,0.04);border-radius:8px;font-size:11px;color:var(--color-ink2);">
