...
const Router = (() => {
  const SCREEN_FASE = {
    home: null, about: null, planificar: 'P', personalizar: 'P', hacer: 'H', verificar: 'V', dashboard: 'V', actuar: 'A',
  };
  ...
  function _render(p) {
    ...
    if (fn) {
      ...
      try { if (currentScreen === 'verificar' || currentScreen === 'dashboard') Verificar.attach(); } catch(e) {}
