...
const Planificar = (() => {
  ...
  function _renderGeneralFormV2() {
    return `<form class="form-screen" id="form-planificar" novalidate style="padding:0;">
      ...
      <div class="form-group"><label class="form-label" for="inp-profesional">Asesor externo (quien elaboró la inspección) *</label><input class="form-input" id="inp-profesional" required value="${_fv('inp-profesional')}" placeholder="Nombre del asesor externo"></div>
